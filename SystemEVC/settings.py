"""
Django settings for SystemEVC project.
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_CLASSES': [
        ...
        'rest_framework.throttling.UserRateThrottle',  # для зарегистрированных пользователей
    ],
...
WSGI_APPLICATION = 'SystemEVC.wsgi.application'
