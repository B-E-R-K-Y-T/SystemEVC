...
from notification.views import WorkStatusViewSet, WorkPriorityViewSet, WorkViewSet, ServiceViewSet, ServerViewSet, \
    ServerTypeViewSet, LocationViewSet, OperatingSystemViewSet, ServiceTypeViewSet, ServiceDependencyViewSet, \
    WorkLogViewSet, NotificationViewSet
